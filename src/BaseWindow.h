...
public:
  ...
  BOOL Create(PCWSTR window_name, DWORD dw_style, DWORD dw_exstyle = 0,
              int x = CW_USEDEFAULT, int y = CW_USEDEFAULT,
              int width = CW_USEDEFAULT, int height = CW_USEDEFAULT,
              HWND hwnd_parent = 0, HMENU menu = 0) {
    WNDCLASS wc = {0};
    ...
    m_hwnd = CreateWindowEx(dw_exstyle, ClassName(), window_name, dw_style, x,
                            y, width, height, hwnd_parent, menu,
